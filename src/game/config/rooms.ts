...
export const ROOMS: Record<string, RoomDef> = {
  ...
  corridor: {
    ...
    doors: [
      ...
      },
      {
        ...
        locked: true, lockType: 'puzzle', lockKey: 'valve',
        requiresPower: false, isSecret: false,
        targetRoom: 'power', targetX: 10, targetY: 15,
        label: 'Power Control Room (Drainage Valves Locked)',
      },
    ],
    ambientLight: 0.15,
    ambience: 'water_drip',
  ...
  power: {
    ...
    doors: [
      ...
      {
        id: 'door_power_escape',
        x: 17, y: 11, width: 1, orientation: 'vertical',
        locked: true, lockType: 'power', lockKey: 'power_main',
        requiresPower: true, isSecret: false,
        targetRoom: 'escape', targetX: 2, targetY: 6,
        label: 'Emergency Evacuation Platform (Requires Main Power)',
      },
    ],
    ambientLight: 0.3,
